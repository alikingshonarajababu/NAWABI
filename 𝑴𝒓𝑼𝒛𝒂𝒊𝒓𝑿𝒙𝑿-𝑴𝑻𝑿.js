            ...
            function() {
                ...
                for (const ev of events) {
                    try {
                        ...
                        if (event.config.dependencies && typeof event.config.dependencies == 'object') {
                            for (const dependency in event.config.dependencies) {
                                ...
                                try {
                                    ...
                                    if (!check || isError) throw global.getText('𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿', 'cantInstallPackage', dependency, event.config.name);
                                }
                            }
                        ...
                        logger.loader(global.getText('𝑴𝒓𝑼𝒛𝒂𝒊𝒓𝑿𝒙𝑿-𝑴𝑻𝑿', 'failLoadModule', event.config.name, error), 'error');
                    }
                }
            }()
